  ...
  open "apmoon.txt" for output as #1
...
sub ap_print(topt)
  ...
  if (iap_flg% = 1) then
    ...
    print #1, " "
    print #1, "time and conditions at perigee"
    print #1, "=============================="
    print #1, " "
    ...
    print #1, " "
    print #1, "time and conditions at apogee"
    print #1, "============================="
    print #1, " "
  ...
  print #1, "geocentric distance  ", str$(vecmag(rmoon()), 0, 4), " kilometers"
...
sub jd2str(jdutc)
  ...
  print "calendar date   " + left$(month$(cmonth), lmonth) + " " + str$(int(day)) + ", " + str$(year)

  print " "

  print #1, "calendar date   " + left$(month$(cmonth), lmonth) + " " + str$(int(day)) + ", " + str$(year)
  ...
  print #1, "UTC time       ", str$(thr) + " hours " + str$(tmin) + " minutes " + str$(tsec, 0, 2) + " seconds"
...
sub hrs2str(hours)
  ...
  print #1, "event duration  ", str$(thr) + " hours " + str$(tmin) + " minutes " + str$(tsec, 0, 2) + " seconds"
